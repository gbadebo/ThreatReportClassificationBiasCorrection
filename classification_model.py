...
class Model(object):
	...
	"""
	def trainUsingWeights(self, traindata, trainLabels, weightSrcData, maxvar, svmC, svmGamma, svmKernel):
		...
		self.model.fit(traindata, trainLabels, sample_weight=weightSrcData)
	...
	def computeModelWeight(self, data, maxvar):
		totConf = 0.0
